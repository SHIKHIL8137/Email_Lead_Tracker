...
function TemplateForm({ initial, onSave }) {
  ...
  const insertLink = () => {
    ...
    const linkHtml = `\n<p><a href="${linkUrl}">Visit our site</a></p>`;
  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      ...
      <div>
        ...
        <input
          className={`w-full bg-gray-800 border ${errors.name ? "border-red-500" : "border-gray-700"} text-gray-100 p-2 rounded focus:outline-none focus:border-blue-500`}
          value={name}
      ...
      <div>
        ...
        <input
          className={`w-full bg-gray-800 border ${errors.subject ? "border-red-500" : "border-gray-700"} text-gray-100 p-2 rounded focus:outline-none focus:border-blue-500`}
          value={subject}
      ...
      <div>
        ...
        <textarea
          className={`w-full bg-gray-800 border ${errors.body ? "border-red-500" : "border-gray-700"} text-gray-100 p-2 rounded focus:outline-none focus:border-blue-500`}
          rows={8}
          value={body}
